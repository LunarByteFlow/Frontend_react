        ...
        <div className="flex flex-row md:flex-row bg-gray-100 py-4 md:py-16">
          <div className="w-full md:w-1/2 mr-4">
            <h2 className="text-5xl font-bold mb-8 p-4 rounded-lg text-left">
              <span className="block">Simple & Easy Way</span>
          ...
          <div className="flex justify-center w-full md:w-1/2">
            <div className="flex flex-col">
              <img
                ...
                alt="Image 1"
                className="w-100 h-58 rounded-[40px] m-2 object-cover border-4 border-gray-200 transform hover:scale-105 transition duration-300"
              />
              <img
                src="./images/download.jpeg"
                alt="Image 2"
                className="w-100 h-100 rounded-[40px] m-2 object-cover border-4 border-gray-200 transform hover:scale-105 transition duration-300"
              />
            </div>
            <div className="flex flex-col">
              <img
              ...
              <img
                src="./images/download.jpeg"
                alt="Image 4"
                className="w-100 h-72 rounded-[40px] m-2 object-cover border-4 border-gray-200 transform hover:scale-105 transition duration-300"
              />
            </div>
          </div>
        </div>
